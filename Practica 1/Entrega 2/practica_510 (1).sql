...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-03-2016 a las 01:09:33
...
(20, '¿De que color tiene las alas el gallo?'),
(21, '¿Cuántos años tiene tu madre?'),
(22, '¿Campo o ciudad?'),
(23, '¿Te gusta phpMyAdmin?'),
(24, '¿Cuántas redes sociales estas?');
...
INSERT INTO `respuestas` (`IdRespuesta`, `numOrden`, `Descripcion`, `IdPregunta`) VALUES
(27, 2, 'Azul', 20),
(28, 1, 'Blanco', 20),
(29, 4, 'Rosa', 20),
(31, 1, 'Gris', 20),
...
(38, 1, 'Si', 23),
(39, 2, 'No', 23),
(40, 1, 'Facebook, Twitter, Instagram', 24),
(41, 2, 'Facebook', 24),
(42, 3, 'Twitter', 24),
(43, 4, 'Instagram', 24);
